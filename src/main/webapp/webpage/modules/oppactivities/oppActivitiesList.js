...
function initData() {
	var oppId='${oppActivities.getOppId()}';  //获取商机编号Id
    $('#oppActivitiesTable').bootstrapTable({
        ...
        queryParams : function(params) {
            ...
            searchParam.oppId = oppId === undefined? "" : oppId;
            return searchParam;
        },
  ...
  function refresh(){
   ...
   function add(){
	  jp.openSaveDialog('新增商机跟进', "${ctx}/oppactivities/oppActivities/form?oppId=${oppActivities.oppId}",'800px', '500px');
  }
