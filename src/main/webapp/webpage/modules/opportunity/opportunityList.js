...
function follow_up(id) {
    ...
    jp.openSaveDialog('商机跟进', "${ctx}/opportunity/opportunity/followForm",'800px', '500px');
}
function followUpRecord(id) {
    if(id == undefined){
        id = getIdSelections();
    }
    jp.openViewDialog('商机跟进记录列表', "${ctx}/opportunity/opportunity/followList?id=" + id,'1200px', '600px');
}
